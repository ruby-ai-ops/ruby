...
description: Step-by-step guide for creating new internal MCP server integrations in Ruby that connect to remote platforms (Jira, HubSpot, Salesforce, etc.). Use when adding a new MCP server, implementing a platform integration, or connecting Ruby to a new external service.
---

# MCP Server Runbook: Adding Internal MCP Server Integrations for Remote Platforms

This runbook provides step-by-step instructions for creating new internal MCP server integrations in Ruby that connect to remote platforms (e.g., Jira, HubSpot, Salesforce, etc.).
...
export const YOUR_PROVIDER_SERVER = {
  serverInfo: {
    ...
    documentationUrl: "https://docs.ruby.ad/docs/your-provider",
    instructions: null,
  },
...
- verify every published tool includes its `stake`
