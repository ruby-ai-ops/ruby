...
//
// The Rust layer resolves database names to file paths (name validation + RUBY_POD_DATABASES_DIR
...
// Pragmas every write connection needs to coexist with litestream; @ruby-ai/pod sets the same ones.
...
// The per-database size quota, the same env var @ruby-ai/pod reads for workload writes.
