 ...
 * SQLite database at `${RUBY_SANDBOX_DATABASES_DIR}/{prefix}{name}.db`. Pod names
 ...
 */
export const SANDBOX_DATABASES_DIR_ENV = "RUBY_SANDBOX_DATABASES_DIR";

/** Legacy env key read for sandboxes launched before the owner-neutral ABI. */
export const POD_DATABASES_DIR_ENV = "RUBY_POD_DATABASES_DIR";
...
export const SANDBOX_DATABASE_MAX_SIZE_BYTES_ENV =
  "RUBY_SANDBOX_DATABASE_MAX_SIZE_BYTES";

/** Legacy env key read for sandboxes launched before the owner-neutral ABI. */
export const POD_DATABASE_MAX_SIZE_BYTES_ENV =
  "RUBY_POD_DATABASE_MAX_SIZE_BYTES";
 ...
 */
export const SANDBOX_DATABASE_PREFIX_ENV = "RUBY_SANDBOX_DATABASE_PREFIX";

/** Legacy env key read for sandboxes launched before the owner-neutral ABI. */
export const POD_DATABASE_PREFIX_ENV = "RUBY_POD_DATABASE_PREFIX";

/** How long a connection waits on a locked database before failing. */
export const SANDBOX_DATABASE_BUSY_TIMEOUT_MS = 5000;

/** Compatibility alias for existing `@ruby-ai/pod` consumers. */
 ...
 * @throws SandboxDatabaseError when RUBY_SANDBOX_DATABASES_DIR or
 *   RUBY_SANDBOX_DATABASE_MAX_SIZE_BYTES is absent or invalid. db() only works
