...
//
// Auth and routing come from the invocation environment (RUBY_API_URL is
// workspace-scoped, RUBY_SANDBOX_TOKEN is minted per invocation), read through
...
export const TOOLS_API_URL_ENV = "RUBY_API_URL";
export const TOOLS_SANDBOX_TOKEN_ENV = "RUBY_SANDBOX_TOKEN";
 ...
 */
export const DSBX_PATH_ENV = "RUBY_DSBX_PATH";
