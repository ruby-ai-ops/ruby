 ...
 * - see issue https://ruby.ad/tasks/issues/1655
 * - and related PR https://ruby.ad/ruby/pull/8709
 * @param connectorId
 * @param joinedOnly
 */
    ...
    const c = await throttleWithRedis(
      ...
      () =>
        slackClient.conversations.list({
          ...
          // we observed ~50 channels per call at times see https://ruby.ad/tasks/issues/1655
          limit: 999,
          cursor: nextCursor,
          exclude_archived: true,
        }),
