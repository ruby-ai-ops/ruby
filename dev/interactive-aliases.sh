...
alias ruby-us='gcloud config configurations activate us-central1 && gcloud container clusters get-credentials ruby-kube --region us-central1'
alias ruby-eu='gcloud config configurations activate europe-west1 && gcloud container clusters get-credentials ruby-kube --region europe-west1'
