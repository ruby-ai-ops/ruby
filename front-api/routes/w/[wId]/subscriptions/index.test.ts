...
describe("POST /api/w/:wId/subscriptions", () => {
  ...
  it.each([
    { seatType: "pro", billingPeriod: "monthly", pricePerSeatCents: 2_000 },
    { seatType: "pro", billingPeriod: "yearly", pricePerSeatCents: 19_200 },
    { seatType: "max", billingPeriod: "monthly", pricePerSeatCents: 4_000 },
    { seatType: "max", billingPeriod: "yearly", pricePerSeatCents: 38_400 },
  ])("charges $pricePerSeatCents cents for $seatType $billingPeriod checkout", async ({
    seatType,
    billingPeriod,
    pricePerSeatCents,
  }) => {
