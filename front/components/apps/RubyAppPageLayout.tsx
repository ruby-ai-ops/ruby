...
import { Spinner, Tabs, TabsList, TabsTrigger } from "@ruby-ai/sparkle";
    ...
    () =>
      app ? (
        <AppLayoutSimpleCloseTitle
          title={app.name}
          onClose={() => {
            void router.push(rubyAppsListUrl(owner, app.space));
          }}
        />
      ) : undefined,
    [owner, app, router]
