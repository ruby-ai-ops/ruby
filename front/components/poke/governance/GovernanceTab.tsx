...
import {
  RUBY_MCP_SERVER_DESCRIPTION,
  RUBY_MCP_SERVER_LABEL,
} from "@app/components/workspace/settings/RubyMcpServerSettingsItem";
import {
...
import { isRubyMcpServerEnabled } from "@app/lib/api/mcp_server/ruby_mcp_server_settings";
...
import { Chip, LinkWrapper, SliderToggle, Spinner } from "@ruby-ai/sparkle";
...
function buildFeatureRows(owner: LightWorkspaceType): GovernanceRow[] {
  ...
  return [
    ...
    {
      key: "rubyMcpServer",
      auditAction: "ruby_mcp_server.settings_updated",
      label: RUBY_MCP_SERVER_LABEL,
      description: RUBY_MCP_SERVER_DESCRIPTION,
      value: booleanToggle(isRubyMcpServerEnabled(owner.metadata)),
      groupIds: [],
    },
    {
