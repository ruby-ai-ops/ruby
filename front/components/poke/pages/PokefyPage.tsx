...
export function PokefyPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!fullUrl.startsWith("http://") && !fullUrl.startsWith("https://")) {
      if (fullUrl.startsWith("ruby.ad/") || fullUrl.startsWith("eu.ruby.ad/")) {
        fullUrl = "https://" + fullUrl;
      } else if (fullUrl.startsWith("w/")) {
        // Use current protocol and host
        // - In dev: http://localhost:3000
        // - In prod: https://ruby.ad (or https://eu.ruby.ad)
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <p className="mb-4 text-sm text-gray-600">
        Enter a Ruby URL below and you'll be redirected to the poke equivalent
        page.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-6">
        <div>
          ...
          <input
            ...
            placeholder="https://ruby.ad/w/workspace/assistant/conversation"
        ...
        <ul className="space-y-1">
          <li>
            ...
            <code className="rounded bg-gray-200 px-1">
              https://ruby.ad/w/workspace/assistant/conv123
            </code>
          </li>
          <li>
            Protocol optional:{" "}
          ...
          <li>
            EU subdomain:{" "}
            <code className="rounded bg-gray-200 px-1">
              eu.ruby.ad/w/workspace/assistant/conv123
            </code>
          </li>
          <li>
            Just the path:{" "}
