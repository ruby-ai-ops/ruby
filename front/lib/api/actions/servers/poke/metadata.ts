...
export const POKE_TOOLS_METADATA = [
...

  {
    ...
    description:
      "Fetch metadata for a target Ruby workspace. Requires Ruby super user privileges.",
    schema: {
      workspace_id: z
        .string()
...

  {
    ...
    description:
      "List end-user feedback (thumbs up/down and free-text comments) on Ruby global agents " +
    ...
    schema: {
      ...
      agent_id: z
        ...
        .optional()
        .describe(
          "Restrict to a single global agent id (e.g. 'ruby'). Omit for all global agents."
        ),
      direction: z
        .enum(["up", "down"])
        .optional()
...
export const POKE_SERVER = {
  serverInfo: {
    ...
    version: "1.0.0",
    description:
      "Ruby-internal tools for cross-workspace data access (poke). Requires super user privileges.",
    authorization: null,
