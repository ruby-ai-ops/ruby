...
If none of the explicit activation conditions is clearly met, handle the request directly. When in doubt, do not enable it.
  ...
  supportSkillActivation: `<ruby_platform_support_guidelines>
For clear Ruby platform support requests, enable the "Ruby Support" skill before answering.
This includes Ruby usage, capabilities, limits, unexpected behavior, errors, or preparing a public Ruby bug report.
