...
const PUBLIC_URL = "https://eu.ruby.ad";
...
describe("getOAuthRedirectBaseUrl", () => {
  ...
  it("points OAuth providers at the app, where the SPA serves the finalize page", () => {
    process.env.NEXT_PUBLIC_RUBY_APP_URL = "https://app.ruby.ad";
    process.env.NEXT_PUBLIC_RUBY_API_URL = PUBLIC_URL;
    delete process.env.RUBY_OAUTH_REDIRECT_BASE_URL;

    expect(config.getOAuthRedirectBaseUrl()).toBe("https://app.ruby.ad");
  });

  it("honours an explicit override", () => {
    process.env.NEXT_PUBLIC_RUBY_APP_URL = "https://app.ruby.ad";
    process.env.RUBY_OAUTH_REDIRECT_BASE_URL = "https://oauth.example.com";
