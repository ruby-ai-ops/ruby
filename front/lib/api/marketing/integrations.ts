...
// Builds the public-facing integration registry consumed by the marketing
// site's integrations listing. Aggregates internal MCP servers, remote MCP
// servers, and connectors into a single deduplicated, name-sorted list.
