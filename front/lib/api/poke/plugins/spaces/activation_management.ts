...
export const activationManagementPlugin = createPlugin({
  manifest: {
    ...
    description:
      "Activation gets dormant or low-fluency users real value from Ruby. " +
      ...
      "Choose [Experimental] Goal Pod to keep a job moving instead of training someone on Ruby.",
    ...
    args: {
      podType: {
        ...
        label: "Pod type",
        description:
          "A Learning Space helps someone get going on Ruby. A Goal Pod keeps a job moving.",
        values: [
      ...
      workAreas: {
        ...
        label: "Work Areas",
        description:
          "Background about the user that Ruby keeps in mind across every nudge — " +
      ...
      activationPlaybook: {
        ...
        description:
          "Step-by-step playbook or onboarding instructions for activating this user on Ruby",
        dependsOn: { field: "guidance", value: "curated" },
      },
      forceRecreate: {
        type: "boolean",
