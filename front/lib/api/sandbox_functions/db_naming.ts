 ...
 * paths (`resolvePodDatabaseName` here, `resolveDatabasePath` in cli/ruby-sandbox/pod/db.ts) prefer
 ...
 *
 * Mirrors `resolveDatabasePath` in cli/ruby-sandbox/pod/db.ts so reconcile applies schema changes
