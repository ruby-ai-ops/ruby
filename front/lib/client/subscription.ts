...
// Fixed Enterprise monthly-equivalent prices, including the platform basis.
export const CP_ENTERPRISE_PRO_SEAT_COST_YEARLY = 44;
export const CP_ENTERPRISE_MAX_SEAT_COST_YEARLY = 140;
