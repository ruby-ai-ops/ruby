-- Seed script for ruby-hive dev environment
-- This SQL file seeds a dev user, workspace, and associated resources.
--
-- SINGLE SOURCE OF TRUTH: This file is used by both:
-- - ruby-hive (x/henry/ruby-hive) for seeding dev environments
-- - front/lib/dev/ruby_hive_seed_schema.test.ts for schema validation
--
-- MAINTAINABILITY:
...
inserted_user AS (
  INSERT INTO users (
    ...
    "workOSUserId", provider, "providerId", "imageUrl",
    "isRubySuperUser", "lastLoginAt", "createdAt", "updatedAt"
  )
  VALUES (
    :userId,
    :username,
