...
// or @ruby-ai/sparkle into the import graph (the worker bundle forbids sparkle).
...
// to avoid importing @ruby-ai/sparkle.
export function buildSkillInstructionsExtensionsForServer(): Extensions {
  return [
    ...
    // imports markdownHeaderClasses from @ruby-ai/sparkle, which is forbidden in
