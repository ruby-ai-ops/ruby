...
export function WithRubyClaudeOpusFiveConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyClaudeOpusFive extends Base {
    ...
    static readonly modelConfig = CLAUDE_OPUS_5_DEFAULT_MODEL_CONFIG;
  }

  return RubyClaudeOpusFive;
}
