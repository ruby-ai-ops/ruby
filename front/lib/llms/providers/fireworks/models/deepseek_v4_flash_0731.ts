...
export function WithRubyDeepSeekDeepSeekV4Flash0731Config<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyDeepSeekDeepSeekV4Flash0731 extends Base {
  ...
  return RubyDeepSeekDeepSeekV4Flash0731;
}
