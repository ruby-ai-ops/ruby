...
export class RubyGoogleGeminiThreeDotFiveFlashLiteEuropeAgentPlatformStream extends WithRubyGoogleGeminiThreeDotFiveFlashLiteConfig(
...
defineRubyStreamEndpoint(
  RubyGoogleGeminiThreeDotFiveFlashLiteEuropeAgentPlatformStream
);
