...
export const FREE_SEAT_LIFETIME_AWU_CREDITS = 100;
...
export const PRO_SEAT_MONTHLY_AWU_CREDITS = 500;
export const MAX_SEAT_MONTHLY_AWU_CREDITS = 2_500;
