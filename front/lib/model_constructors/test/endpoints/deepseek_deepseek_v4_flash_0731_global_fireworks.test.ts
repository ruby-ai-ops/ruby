...
export const DeepSeekDeepSeekV4Flash0731GlobalFireworksStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new DeepSeekDeepSeekV4Flash0731GlobalFireworksStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/deepseek_deepseek_v4_flash_0731_global_fireworks.test.ts
