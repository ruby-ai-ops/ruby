...
export const OpenAIGptFiveDotSixLunaEuropeOpenAIResponsesStreamSetup: StreamSetup =
  {
    createInstance: () =>
    ...
    tests: {
      // "minimal" is not supported by gpt-5.6. "maximal" maps to OpenAI's native
      // "max" and is accepted.
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_five_dot_six_luna_eu_openai_responses.test.ts
