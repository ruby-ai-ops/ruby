...
import { LegacyButton as Button } from "@ruby-ai/sparkle";
...
const CASE_STUDIES: Record<string, string> = {
  ...
  fleet: "/customers/how-valentine-head-of-marketing-at-fleet-uses-ruby",
  kyriba: "/customers/kyriba-accelerating-innovation-with-ruby",
  malt: "/customers/malt-customer-support",
  mirakl: "/customers/why-mirakl-chose-ruby-as-its-go-to-agentic-solution",
  payfit: "/customers/ruby-ai-payfit-efficiency",
  pennylane: "/customers/pennylane-customer-support-journey",
  persona: "/customers/how-persona-hit-80-ai-agent-adoption-with-ruby",
  profound: "/customers/profound-post-sales-team-reclaimed-1800-hours",
  qonto: "/customers/qonto-ruby-ai-partnership",
  wakam:
  ...
  vanta:
    "/customers/how-vantas-gtm-team-saves-thousands-of-hours-annually-with-ruby",
};
...
export default function TrustedBy({
  ...
  // Keep the original proof implementation available for a future verified
  // customer rollout without presenting it before Ruby has public references.
  if (!isMarketingSurfaceVisible(MARKETING_SURFACES.trustedSection)) {
    return null;
  }
