...
import { Check, ChevronLeft, ChevronRight, cn, Icon } from "@ruby-ai/sparkle";
...
export function GleanDeepDive({
  pros,
  testimonials,
  showSocialProof = true,
}: GleanDeepDiveProps) {
  return (
    <section id="ruby-deep-dive" className="w-full pt-2 pb-4 md:pt-8 md:pb-24">
        ...
        <div className="overflow-hidden rounded-3xl border-2 border-[#1C91FF] bg-white shadow-2xl shadow-[#1C91FF]/10">
          ...
          <div className="flex flex-col justify-between gap-4 bg-[#1C91FF] px-8 py-6 text-white md:flex-row md:items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold">
                Ruby: Best for specialized AI agents connected to company
                knowledge
              </h2>
            </div>
            {showSocialProof && (
          ...
          <div className="p-5 md:p-12">
            <p className="mb-10 text-xl font-medium leading-relaxed text-gray-700">
              ...
              Ruby is an AI platform purpose-built for team collaboration at
            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <div className="h-fit rounded-2xl border border-gray-100 bg-gray-50 p-8">
                ...
                <P size="sm" className="mb-6 text-muted-foreground">
                  Ruby agents are shared across your team. When one person
