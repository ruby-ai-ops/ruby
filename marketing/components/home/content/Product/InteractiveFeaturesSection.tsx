...
import { ChevronUp, Separator } from "@ruby-ai/sparkle";
...
const features: FeatureItem[] = [
  ...
  },
  {
    ...
    description:
      "Connect Ruby to your internal systems and workflows, such as Slack, GitHub, Notion and more.",
  },
  {
    id: "tools",
  ...
  },
  {
    ...
    description:
      "Integrate Ruby directly into your existing development environment.",
  },
  {
    id: "workflows",
    title: "Add to workflows",
    description:
      "Automate complex workflows with Ruby agents like multi-step processes, data orchestration, and more.",
  },
];
...
const getImageSrc = (activeFeature: string) => {
  switch (activeFeature) {
    ...
    case "workflows":
      return "/static/landing/product/zendesk-ruby.svg";
    default:
      return "";
  }
};
