...
export const REMAINING_INDUSTRY_TITLES: Record<string, string> =
  Object.fromEntries(
    Object.entries(specs).map(([id, spec]) => [id, spec.title])
  );

export const REMAINING_INDUSTRY_REQUIRED_TERMS: Record<string, string[]> =
  Object.fromEntries(
    Object.entries(specs).map(([id, spec]) => [id, spec.terms])
  );

export const REMAINING_INDUSTRY_EXPECTED_DOWNLOADS: Record<string, string[]> =
  Object.fromEntries(
...
export const REMAINING_INDUSTRY_ORDER: Record<string, string[]> = {
  stonebridge: [
    "stonebridge-schedule-recovery",
    "stonebridge-site-safety-brief",
    "stonebridge-subcontractor-readiness",
...
export const REMAINING_INDUSTRY_INDICATORS: Record<
  string,
