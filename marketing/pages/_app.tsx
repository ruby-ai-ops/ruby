...
// Replaces the old precompiled `@ruby-ai/sparkle/dist/sparkle.css` concat.
...
const CONSOLE_MESSAGE_SHOWN_KEY = "ruby_console_message_shown";
      ...
      if (!alreadyShown) {
        ...
        console.log(
          "%cWe're creating a new AI operating system that has the potential to change how companies operate.\n\n" +
            "Our mission at Ruby is to transform how work gets done by letting any team\n" +
        ...
        console.log(
          "%c👉 Learn more about us: %chttps://ruby.ad/home/about",
