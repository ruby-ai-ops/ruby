...
export const getServerSideProps: GetServerSideProps<CoursePageProps> = async (
  ...
  // Marketing does not resolve the academy user at SSR — academy progress is
  // fetched client-side from the academy endpoints (served by front today),
  // which read the session cookie themselves.
  const user: { firstName: string; sId: string } | null = null;
