...
export const getServerSideProps: GetServerSideProps<ChapterPageProps> = async (
  ...
  // Marketing does not resolve the academy user at SSR — see academy/index.tsx.
  // The chapter-visit recording also moves client-side; the academy progress
  // endpoints (served by front today) capture visits from the client.
  const academyUser: { id: number; firstName: string; sId: string } | null =
    null;
