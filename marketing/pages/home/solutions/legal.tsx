...
import {
  ...
  // Stories,
  UseCases,
} from "@marketing/components/home/content/Solutions/configs/legalConfig";
...
export default function LegalNextJS() {
...
LegalNextJS.getLayout = (page: ReactElement, pageProps: LandingLayoutProps) => {
