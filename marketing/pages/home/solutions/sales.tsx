...
import {
  ...
  // Stories,
  UseCases,
} from "@marketing/components/home/content/Solutions/configs/salesConfig";
...
export default function SalesNextJS() {
...
SalesNextJS.getLayout = (page: ReactElement, pageProps: LandingLayoutProps) => {
