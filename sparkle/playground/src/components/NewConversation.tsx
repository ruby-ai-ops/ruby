...
import {
  ...
  NotionLogo,
  SlackLogo,
} from "@ruby-ai/sparkle/logo/platforms";
...
const ABOUT_RUBY_SECTIONS: AboutRubySection[] = [
  {
    id: "apps",
    title: "Get Ruby everywhere",
    description: "Bring Ruby to your desktop, your phone, and your browser.",
    layout: "feature",
    items: [
      {
        id: "desktop",
      ...
      },
      {
        ...
        name: "Mobile app",
        description:
          "Take Ruby anywhere. Start conversations and pick up tasks on the go.",
        action: "Get the app",
      ...
      },
      {
        ...
        description:
          "Bring Ruby into any tab to summarize, draft, and search as you browse.",
  ...
  },
  {
    ...
    description: "Let Ruby work with the data and apps your team already uses.",
    layout: "compact",
    items: [
      {
        id: "slack",
        name: "Slack",
        description: "Chat with Ruby and sync conversations.",
        action: "Connect",
        logo: SlackLogo,
      },
      {
      ...
      },
      {
        id: "github",
        name: "GitHub",
        description: "Give Ruby context on your codebase.",
        action: "Connect",
        logo: GithubLogo,
      },
      {
  ...
  },
  {
    ...
    description: "Automate and extend Ruby from your own tools.",
    layout: "feature",
    items: [
      {
        id: "api",
...
export function NewConversationActionBar({
  ...
  // not on the static "About Ruby" tab.
  const isAgentTab = value !== "about_ruby";
    ...
    <div className="flex w-full items-center gap-2">
      <FreeButtonSwitch<WelcomeAgentTab>
        ...
        options={[
          ...
          { value: "about_ruby", label: "More with Ruby" },
...
export function NewConversation({
  ...
  // Visual for an About Ruby item: brand logos keep their own colors inside a
  // bordered tile; Sparkle icons use a highlight-tinted avatar (like skills).
  const renderAboutVisual = (item: AboutRubyItem) => {
    if (item.logo) {
  ...
  const renderAboutRuby = () => (
    <div className="flex flex-col gap-8">
      {ABOUT_RUBY_SECTIONS.map((section) => (
  ...
  const isAboutRuby = displayTab === "about_ruby";
        ...
        <div className="flex w-full max-w-4xl flex-col gap-3">
          <div className="mx-auto flex w-full max-w-xl flex-col gap-3 px-4 pb-8 text-center">
            <div className="heading-2xl text-foreground">
              {isAboutRuby ? "About Ruby" : "Agents & Skills"}
            </div>
            <SearchInput
              ...
              placeholder={
                isAboutRuby ? "Search Ruby" : "Search skills and agents"
              }
              className="w-full"
            />
          </div>
