import animSpinnerBrand from "@sparkle/lottie/spinnerRuby";
import animSpinnerBrandColored from "@sparkle/lottie/spinnerRubyColored";
import animSpinnerBrandColoredGray from "@sparkle/lottie/spinnerRubyColoredGray";
...
/**
 * A branded, Ruby-logo loading indicator for indeterminate waits.
 *
 * @deprecated Use Spinner instead (or a LoadingBlock skeleton when the
 * loading layout is known ahead of time).
 *
 * @summary Deprecated Ruby-branded loading indicator — use Spinner.
 */
