...
export const WithActionsMenu: Story = {
  args: {
    title: "supportExpert",
    pictureUrl: "https://ruby.ad/static/droidavatar/Droid_Pink_4.jpg",
...
export const SecondaryVariant: Story = {
  args: {
    title: "docsWriter",
    pictureUrl: "https://ruby.ad/static/droidavatar/Droid_Yellow_4.jpg",
    subtitle: "By: Ruby",
...
export const LongContentTruncation: Story = {
  args: {
    ...
    pictureUrl: "https://ruby.ad/static/droidavatar/Droid_Green_2.jpg",
  ...
  render: () => (
    <CardGrid>
      <CompactAssistantCard
        ...
        pictureUrl="https://ruby.ad/static/droidavatar/Droid_Lime_3.jpg"
        onClick={fn()}
      />
      <CompactAssistantCard
        title="codingBuddy"
        description="Assistant for code beginners. Get help writing code and getting started."
        pictureUrl="https://ruby.ad/static/droidavatar/Droid_Yellow_3.jpg"
        onClick={fn()}
      />
      <CompactAssistantCard
        title="supportExpert"
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-4">
      ...
      <LargeAssistantCard
        ...
        pictureUrl="https://ruby.ad/static/droidavatar/Droid_Yellow_2.jpg"
