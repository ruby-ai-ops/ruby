...
struct NewConversationView: View {
    ...
    @State private var pieceOffsets: [CGSize] = Array(repeating: .zero, count: RubyLogoPiecesView.pieceCount)
    @State private var pieceRotations: [Double] = Array(repeating: 0, count: RubyLogoPiecesView.pieceCount)
    ...
    private func startEasterEgg() {
        ...
        let count = RubyLogoPiecesView.pieceCount
