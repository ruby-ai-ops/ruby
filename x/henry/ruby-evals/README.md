# Ruby Agent Evaluation System

A robust evaluation framework for testing and benchmarking Ruby agents using CSV-based prompts and automated LLM-as-judge scoring with majority voting.

## Overview

This tool allows you to:
- Evaluate multiple Ruby agents against a set of test prompts
...
message (as Ruby content fragments). Separate multiple files with commas inside
...
attachment. Ruby's per-file size limits apply, and a file that cannot be read or
...
- Links to Ruby conversations for debugging
...
2. Open in Ruby: `https://ruby.ad/w/{workspace}/assistant/{conversationId}`
...
│   ├── ruby-client.ts   # Ruby API client with retries
