...
<body>
  <div class="container">
    ...
    <footer>
      <p>Ruby Agent Evaluation System • ${metadata.conversationIds.length} conversations</p>
    </footer>
  </div>
          ...
          <div class="detail-section">
            ...
            <div class="meta-grid">
              ...
              <div class="meta-item">
                ...
                <a href="https://ruby.ad/w/${workspaceId}/assistant/${result.agentConversationId}" target="_blank" style="color: var(--primary)">
