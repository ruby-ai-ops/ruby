...
_ruby_hive_services=(sdk sparkle front core oauth connectors front-workers front-spa-poke front-spa-app viz)
_ruby_hive_warm_state_services=(front front-api core oauth connectors front-workers front-spa-poke front-spa-app viz)
...
_ruby_hive_fast_state_rows() {
  ...
  while IFS= read -r env_dir; do
    ...
    if _ruby_hive_name_in_lines "$env_name" "$docker_warm_envs"; then
      ...
      _ruby_hive_service_is_running "$env_name" "sparkle"; then
      state="cold"
    fi
