...
export interface MultiplexerAdapter {
  ...
  /**
   * List all ruby-hive sessions (sessions with "ruby-hive-" prefix)
   */
...
/**
 * Standard session name prefix for all ruby-hive sessions
 */
export const SESSION_PREFIX = "ruby-hive-";
 ...
 */
export const MAIN_SESSION_NAME = "ruby-hive-main";
